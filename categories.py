...
class Categories:
    ...
    def __init__(self):
        ...
        self._categoriesdel = self._load_categoriesdel()
    ...
    # Возвращает справочник категорий расходов из БД
    def _load_categoriesdel(self) -> List[Category]:
        categories = table.fetchall_del(
            "category", "codename name is_base_expense aliases".split()
        )
        categories = self._fill_aliases(categories)
        return categories
    ...
    # Возвращает справочник категори
    def get_all_categories(self) -> List[Dict]:
        return self._categories

    # Возвращает справочник категорий
    def get_all_categoriesdel(self) -> List[Dict]:
        return self._categoriesdel
